...
int main(int argc, char **argv)
{
  ...
  auto env = (Environment*) gInterpreter->ProcessLine("env;");
  ...
  auto r2 = f2.Define("h_al", "ApplyFineAlignment( tdfslot_, timestamp , x_L_1_F, x_L_2_N, x_L_2_F, x_R_1_F, x_R_2_N, x_R_2_F, y_L_1_F, y_L_2_N, y_L_2_F, y_R_1_F, y_R_2_N, y_R_2_F)" )
  ...
  //auto h_timestamp_sel = r2.Histo1D(ROOT::RDF::TH1DModel("h_timestamp_sel", ";timestamp;rate   (Hz)", int(timestamp_bins), timestamp_min-0.5, timestamp_max+0.5), "timestamp");
  //h_timestamp_sel.GetValue();
